...
(cl:defmethod raw-val ((m <i2c>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader i2c_communication-msg:raw-val is deprecated.  Use i2c_communication-msg:raw instead.")
  (raw m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <i2c>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'raw)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <i2c>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'raw)) (cl:read-byte istream))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<i2c>)))
  ...
  "c70b01a642177dd8a27557273aacf98d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'i2c)))
  "Returns md5sum for a message object of type 'i2c"
  "c70b01a642177dd8a27557273aacf98d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<i2c>)))
  ...
  (cl:format cl:nil "Header header~%uint16 raw~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'i2c)))
  "Returns full string definition for message of type 'i2c"
  (cl:format cl:nil "Header header~%uint16 raw~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
