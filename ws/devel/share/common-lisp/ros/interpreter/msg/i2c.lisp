...
(cl:defmethod cl:initialize-instance :after ((m <i2c>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'i2c)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name interpreter-msg:<i2c> is deprecated: use interpreter-msg:i2c instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <i2c>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interpreter-msg:header-val is deprecated.  Use interpreter-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <i2c>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interpreter-msg:action-val is deprecated.  Use interpreter-msg:action instead.")
  (action m))

(cl:ensure-generic-function 'address-val :lambda-list '(m))
(cl:defmethod address-val ((m <i2c>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interpreter-msg:address-val is deprecated.  Use interpreter-msg:address instead.")
  (address m))

(cl:ensure-generic-function 'register-val :lambda-list '(m))
(cl:defmethod register-val ((m <i2c>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interpreter-msg:register-val is deprecated.  Use interpreter-msg:register instead.")
  (register m))

(cl:ensure-generic-function 'bit_start-val :lambda-list '(m))
(cl:defmethod bit_start-val ((m <i2c>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interpreter-msg:bit_start-val is deprecated.  Use interpreter-msg:bit_start instead.")
  (bit_start m))

(cl:ensure-generic-function 'length-val :lambda-list '(m))
(cl:defmethod length-val ((m <i2c>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interpreter-msg:length-val is deprecated.  Use interpreter-msg:length instead.")
  (length m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <i2c>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interpreter-msg:value-val is deprecated.  Use interpreter-msg:value instead.")
  (value m))
